...
app_only='^(\.claude/|outreach/|src-tauri/|src/components/|src/App\.tsx$|src/main\.tsx$|src/lib/.*\.tsx?$|src/.*__tests__/|tests/|\.github/|supabase/|frontend/|backend/|index\.html$|vite\.config\.mts$|docs/IOS\.md$|HANDOFF\.md$|scripts/i18n-wip/|scripts/learn-videos/)'
